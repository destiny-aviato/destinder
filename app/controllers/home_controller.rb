class HomeController < ApplicationController
  ...
  def test2(username)
    ...
    character_data['Response']['characters']['data'].each_with_index do |character, index|
      last_character = character[0] if index == 0
      character_races = { 0 => 'Titan', 1 => 'Hunter', 2 => 'Warlock' }
  ...
  def get_map
    ...
    get_characters.on_complete do |character_response|
      ...
      get_last_activity.on_complete do |activity_response|
        ...
        map_name = activity_data['Response']['definitions']['activities'][map_hash.to_s]['activityName']
        img = activity_data['Response']['definitions']['activities'][map_hash.to_s]['pgcrImage']
